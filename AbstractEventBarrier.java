public abstract class AbstractEventBarrier {
	...
	/**
	 * Signal the event and block until all threads that wait for this event
	 * have responded. The EventBarrier returns to an unsignaled state before
	 * raise() returns.
	 * 
	 * @throws InterruptedException
	 */
	...
	/**
	 * Indicate that the calling thread has finished responding to a signaled
	 * event, and block until all other threads that wait for this event have
	 * also responded.
	 * 
	 * @throws InterruptedException
	 */
